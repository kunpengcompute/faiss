...
/*
 * @brief Quantize float array to float16 array.
 * @param src Pointer to the input float array.
 * @param n Number of elements in the input array.
 * @param out Pointer to the output float16 array.
 */
...
/*
 * @brief Quantize float array to uint8 array.
 * @param src Pointer to the input float array.
 * @param n Number of elements in the input array.
 * @param out Pointer to the output uint8 array.
 */
...
/*
 * @brief Quantize float array to uint8 array with scale and bias.
 * @param src Pointer to the input float array.
 * @param n Number of elements in the input array.
 * @param out Pointer to the output uint8 array.
 * @param scale Scale factor for quantization.
 * @param bias Bias value for quantization.
 */
 ...
 * @param src Pointer to the input float array.
 * @param n Number of elements in the input array.
 * @param out Pointer to the output int8 array.
 */
...
/*
 * @brief Quantize float array to int8 array with scale.
 * @param src Pointer to the input float array.
 * @param n Number of elements in the input array.
 * @param out Pointer to the output int8 array.
 * @param scale Scale factor for quantization.
...
/*
 * @brief Compute quantization parameters (scale and bias) based on the input data.
 * @param n Number of elements in the input array.
 * @param x Pointer to the input float array.
 * @param metric_type Type of metric for quantization (e.g., L2 or inner product).
 * @param range Range of quantization.
 * @param scale Pointer to store the computed scale factor.
 * @param bias Pointer to store the computed bias value.
 * @return 1 if parameters are computed successfully, 0 otherwise.
 */
...
/*
 * @brief Quantize float array to uint8 or int8 array based on the metric type.
 * @param n Number of elements in the input array.
 * @param x Pointer to the input float array.
 * @param out Pointer to the output quantized array.
 * @param metric_type Type of metric for quantization (e.g., L2 or inner product).
 * @param use_parm Whether to use external scale and bias parameters.
 * @param scale Scale factor for quantization (used if use_parm is 1).
 * @param bias Bias value for quantization (used if use_parm is 1).
 */
