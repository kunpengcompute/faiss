...
```text
faiss/
├─ 0001-faiss_1.8.0-optimize-neq.patch         // 基于v1.8.0版本的全量优化补丁
├─ 0002-faiss_1.8.0-optimize-eqv.patch         // 基于v1.8.0版本的等价优化补丁
├─ 0001-faiss_1.14.3-optimize-rabitq.patch     // 基于v1.14.3版本的RabitQ索引优化补丁
├─ README.md                                   // 项目介绍
└── docs
   ├── LICENSE
   └── zh
